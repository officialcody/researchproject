...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.22/pdfmake.min.js"></script>
    ...
    <div id="print" style=" align-content:center;">
        <br>
        <h2 style="text-align:center; color: rgb(99,97,97);background-color: rgb(255,255,25:);"><strong>Report of documens uploded by <?php echo $result2["prefix"]." ".$result2["full_name"]?></strong></h2><br>
