...
<div align="right" style="width:100%;padding-bottom:10px; margin-left:26% "><a  href="add_user.php" class="link"><img alt='Add' title='Add' src='images/add.png' width='15px' height='15px'/>&nbsp;Add User</a></div>
